...
export { placeOrder, confirmOrder, cancelOrder } from './commands';

// Re-export event types and factories
export type { OrderPlaced, OrderConfirmed, OrderCancelled } from './events';
export { createOrderPlaced, createOrderConfirmed, createOrderCancelled } from './events';
